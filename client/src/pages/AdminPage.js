    ...
    <p>
        Мы гарантируем безопасность вашей платежной информации и предлагаем различные способы оплаты для вашего удобства.
                ...
                <div className="about_tag">
                    <h1>О нас</h1>
                    <p>
                    Наша история началась с любви к книгам и желания делиться этой любовью с миром. Мы стремимся быть вашим надежным партнером в мире литературы, предлагая широкий выбор книг высокого качества, быструю доставку и отличный сервис. Добро пожаловать в мир знаний и вдохновения с нами!
                    </p>
